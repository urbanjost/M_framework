...
implicit none
   ...
   call unit_check_end('flush_trail',msg='')
...
implicit none
   ...
   call unit_check_end('set_stdout_lun',msg='')
...
implicit none
   ...
   call unit_check_end('where_write_message_all',msg='')
...
implicit none
   ...
   call unit_check_end('write_message_only',msg='')
