...
!!
!!##DESCRIPTION
!!    M_framework__attr(3f) is a Fortran module that uses common ANSI escape sequences
...
module M_framework__attr
use, intrinsic     :: iso_fortran_env, only : stderr=>ERROR_UNIT,stdin=>INPUT_UNIT,stdout=>OUTPUT_UNIT
use, intrinsic     :: iso_c_binding, only: c_int
use, non_intrinsic :: M_framework__msg, only : str
implicit none
private
public  :: attr
public  :: attr_mode
...
!>
!!##NAME
!!    attr(3f) - [M_framework__attr] substitute escape sequences for HTML-like syntax
!!               in strings
!!    (LICENSE:MIT)
!!
!!##SYNOPSIS
